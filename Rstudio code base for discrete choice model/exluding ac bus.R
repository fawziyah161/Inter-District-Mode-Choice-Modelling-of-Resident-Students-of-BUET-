...
database = subset(database, choice %in% c(1,3,4,5))
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate") {
  ...
  mnl_settings = list(
    alternatives  = c(bus = 1,train=3,personal_car=4,rental_car=5), 
    avail         = list(bus=bus_avail,train=train_avail,personal_car = personal_car_avail,rental_car= rental_car_avail), 
    choiceVar     = choice,
    utilities     = V
  )
