...
### Set core controls
apollo_control = list(
  modelName       = "ASC one cost coeff sing time coeff",
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate") {
  ...
  V[["bus"]] = ASC_bus + B_cost * (tc_bus/100) + B_traveltime * tt_bus

  V[["ac_bus"]] = ASC_ac_bus +B_cost * (tc_acbus/100) + B_traveltime * tt_acbus
 
  V[["train"]] = ASC_train +B_cost * (tc_train/100) + B_traveltime * tt_train
  
  V[["personal_car"]] = ASC_personal_car + B_cost * (tc_carpersonal_n / 100) + B_traveltime * tt_car_personal 
  
  V[["rental_car"]] = ASC_rental_car + B_cost * (tc_carrental_n / 100) + B_traveltime * tt_car_rental
