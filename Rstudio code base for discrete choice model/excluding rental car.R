...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate") {
  ...
  V[["personal_car"]] = ASC_personal_car + B_cost_carp * (tc_carpersonal_n / 100) + B_traveltime_carp * (tt_car_personal/10) + B_incomes_carp * income_self + B_incomef_carp * income_fam
